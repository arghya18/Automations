...
df2 = spark.sql("select * from drive_event_attr_flat where date_key=20201204 and insert_version=2012210729 and event_date is not null and drive_serial_num is not null")
